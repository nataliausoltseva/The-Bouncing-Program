...
public class AnimationPanel extends JComponent implements Runnable {
	...
	protected void createNewShape(int x, int y) {
		...
		case 0: { //rectangle
			s =  new MovingRectangle(x, y, currentWidth, currentHeight, marginWidth, marginHeight,currentBorderColor, currentFillColor,currentPath);
			shapes.add(s);
			break;
		}
		case 1: {
			s =  new MovingSquare(x, y, currentWidth, marginWidth, marginHeight,currentBorderColor, currentFillColor,currentPath);
			shapes.add(s);
			break;
		}
		case 2: {
			s =  new MovingEllipse(x, y, currentWidth, currentHeight, marginWidth, marginHeight,currentBorderColor, currentFillColor,currentPath);
			shapes.add(s);
			break;
		}
		case 3: {
			s =  new MovingCircle(x, y, currentWidth, marginWidth, marginHeight,currentBorderColor, currentFillColor,currentPath);
			shapes.add(s);
			break;
		}
		case 4: {
		    s = new MovingQuadCircles(x, y, currentWidth, marginWidth, marginHeight,currentBorderColor, currentFillColor,currentPath);
			shapes.add(s);
			break;
		}
		case 5: {
		    s = new MovingPixelArt(x, y, currentWidth, marginWidth, marginHeight,currentBorderColor, currentFillColor,currentPath);
			shapes.add(s);
			break;
		}
	}
