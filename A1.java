...
public class A1 extends JFrame {
    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        ImageIcon myMovingPathButtonIcon = createImageIcon("mymovingpath.gif");
        pathComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {fallButtonIcon, bounceButtonIcon, myMovingPathButtonIcon });
        pathComboBox.setToolTipText("Set Path");
        pathComboBox.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //set the Current path type based on the selection from combo box: 0 for fall Path, 1 for bouncing path
