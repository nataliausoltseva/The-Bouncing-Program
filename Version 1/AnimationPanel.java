...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    protected void createNewShape(int x, int y) {
        ...
        // uncomment and extend the switch case statement below for each shape you add.
        // The commented version below includes the example for adding the MovingRectangle.
        //
        	switch (currentShapeType) {
        		case 0: 
        			shapes.add(new MovingRectangle(x, y, currentWidth,	currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPathType));
                    break;
                case 1:
                    shapes.add(new MovingOval(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor,currentPathType));
                    break;
                case 2:
                    shapes.add(new MovingChecker(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPathType));
                    break;
                case 3:
                    shapes.add(new MovingGradient(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPathType));
                    break;
                case 4:
                    shapes.add(new MovingShapePattern(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPathType));
                    break;

        	}
        //
        // currentShapeType = index from the combo box, 0 = rectangle, 1 = oval etc.
        // currentPathType = index from the combo box, 0 = falling path, 1 = bouncing path etc.
    }
